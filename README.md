# WhoIsMyCandidate - Spark! Minihack (October 2024)
...
Our project uses a ChatGPT AI trained on information from both presidential candidates' respective campaign sites, allowing users to ask the chatbot questions regarding either of their policies to compare and contrast. This allows the user to make a more informed decision when selecting their candidate.

---

## How We Built It

We used the following technologies to develop our project:
...
We're proud of creating a working prototype of our project that has the potential, if improved upon, to:

- Improve voter turnout
- Promote civic engagement
- Further participation with the government processes to keep the democratic tradition within the US alive
